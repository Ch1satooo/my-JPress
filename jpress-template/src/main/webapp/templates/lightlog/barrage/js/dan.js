...
//初始化函数
var aShowList = document.querySelectorAll('.barrage-s_show div');//获取元素 H5
var oShow = document.querySelector('.barrage-s_show');
var oSend = document.querySelector('.barrage-send');
var oBtn = document.querySelector('.barrage-btn');
var oText = document.querySelector('.barrage-text');
